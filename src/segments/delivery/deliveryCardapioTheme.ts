...
const darkPremium: DeliveryCardapioTheme = {
  ...
  vitrine: {
    ...
    compactThumb: 'relative h-full min-h-0 w-[118px] shrink-0 cursor-pointer overflow-hidden bg-zinc-800',
  ...
  modalOpcoes: {
    sheet:
      'relative flex w-full max-w-2xl min-h-0 flex-col overflow-hidden rounded-t-[32px] border border-white/16 bg-zinc-950 text-zinc-100 shadow-[0_32px_90px_rgba(0,0,0,0.58)] ring-1 ring-cyan-500/10 sm:mx-auto sm:rounded-[32px]',
...
const lightRed: DeliveryCardapioTheme = {
  ...
  vitrine: {
    ...
    compactCard:
      'group flex h-[236px] w-[min(calc(100vw-2rem),320px)] max-w-full shrink-0 items-stretch gap-0 overflow-hidden rounded-[28px] border border-zinc-200/90 bg-white shadow-[0_12px_32px_rgba(0,0,0,0.07)] ring-1 ring-black/[0.03] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-red-200 hover:shadow-[0_18px_40px_rgba(220,38,38,0.1)] sm:h-[240px] sm:min-w-[290px]',
    ...
    compactThumb: 'relative h-full min-h-0 w-[118px] shrink-0 cursor-pointer overflow-hidden bg-zinc-100',
