  ...
  try {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS barber_clientes (
        id SERIAL PRIMARY KEY,
        nome TEXT NOT NULL, cpf TEXT, telefone TEXT, email TEXT,
        data_nascimento TEXT, observacoes TEXT, tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS agendamentos (
        id SERIAL PRIMARY KEY,
        cliente_id INTEGER, cliente_nome TEXT, produto_id INTEGER,
        servico_nome TEXT NOT NULL, barbeiro TEXT DEFAULT 'Qualquer',
        funcionario_id INTEGER, data TEXT NOT NULL, hora TEXT NOT NULL,
        status TEXT DEFAULT 'agendado', observacao TEXT,
        valor REAL DEFAULT 0, fidelidade_computada INTEGER DEFAULT 0,
        tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS fidelidade_regras (
        id SERIAL PRIMARY KEY,
        nome TEXT NOT NULL, meta INTEGER NOT NULL DEFAULT 10,
        descricao TEXT, ativo INTEGER DEFAULT 1, tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS fidelidade_cartoes (
        id SERIAL PRIMARY KEY,
        cliente_id INTEGER NOT NULL, regra_id INTEGER NOT NULL,
        contagem INTEGER DEFAULT 0, total_ganhos INTEGER DEFAULT 0,
        tenant_id INTEGER NOT NULL,
      ...
      CREATE TABLE IF NOT EXISTS fidelidade_historico (
        id SERIAL PRIMARY KEY,
        cliente_id INTEGER NOT NULL, regra_id INTEGER NOT NULL,
        servico_nome TEXT, tipo TEXT, tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS fidelidade_usos (
        id SERIAL PRIMARY KEY,
        cartao_id INTEGER NOT NULL, cliente_id INTEGER NOT NULL,
        regra_id INTEGER NOT NULL, servico_nome TEXT,
        ganhou INTEGER DEFAULT 0, tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS assinatura_planos (
        id SERIAL PRIMARY KEY,
        nome TEXT NOT NULL, descricao TEXT, valor_mensal REAL NOT NULL,
        ativo INTEGER DEFAULT 1, tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS assinatura_clientes (
        id SERIAL PRIMARY KEY,
        cliente_id INTEGER NOT NULL, plano_id INTEGER NOT NULL,
        status TEXT DEFAULT 'ativa', data_inicio TEXT, data_vencimento TEXT,
        tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS assinatura_usos (
        id SERIAL PRIMARY KEY,
        assinatura_id INTEGER NOT NULL, cliente_id INTEGER NOT NULL,
        plano_id INTEGER NOT NULL, servico_nome TEXT, data TEXT,
        tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS plano_servicos (
        id SERIAL PRIMARY KEY,
        plano_id INTEGER NOT NULL, produto_id INTEGER,
        nome_servico TEXT, limite_mensal INTEGER DEFAULT 0,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS barber_funcionarios (
        id SERIAL PRIMARY KEY,
        nome TEXT NOT NULL, cargo TEXT DEFAULT 'Barbeiro',
        telefone TEXT, percentual_repasse REAL DEFAULT 50,
        ativo INTEGER DEFAULT 1, cor TEXT DEFAULT 'zinc',
        tenant_id INTEGER NOT NULL,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
      CREATE TABLE IF NOT EXISTS pagamentos_funcionarios (
        id SERIAL PRIMARY KEY,
        funcionario_id INTEGER NOT NULL, tenant_id INTEGER NOT NULL,
        periodo_inicio TEXT NOT NULL, periodo_fim TEXT NOT NULL,
        qtd_atendimentos INTEGER DEFAULT 0,
        valor_produzido REAL DEFAULT 0, valor_repasse REAL DEFAULT 0,
        observacao TEXT,
        created_at TIMESTAMPTZ DEFAULT NOW()
      );
    `);
