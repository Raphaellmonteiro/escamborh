...
export default function PrivacyPolicyPublicPage() {
  return (
    <LegalPublicDocumentPage
      ...
      intro="Esta página resume a política aplicável ao uso da plataforma Pratory. O operador do serviço deve publicar dados de contato, CNPJ e canal de privacidade atualizados junto a este documento."
