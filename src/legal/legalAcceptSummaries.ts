...
Dados: nome, contato, endereço, CPF quando informado, pedidos, pagamentos na medida necessária, dados de RH inseridos por você, logs de acesso e arquivos enviados ao sistema.

Finalidades: prestar o serviço, cumprir a lei, proteger a conta e a plataforma, e comunicar sobre o uso do sistema.
...
Ao continuar, você confirma que leu o resumo e que pode acessar os documentos completos quando quiser.`;

export const LEGAL_ACCEPTANCE_BUNDLE_LABEL = LEGAL_BUNDLE_VERSION;
